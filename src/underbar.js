...
(function() {
  ...
  _.last = function(array, n) {
    ...
    return n === undefined ? array[length - 1] : array.slice(n - 1, array.length);
  };
  ...
  _.reject = function(collection, test) {
    ...
    return _.filter(collection, cmp);
  };
  ...
  _.map = function(collection, iterator) {
    ...
    var response = [], i;
    for(i = 0; i < collection.length; i++) {
      response.push(iterator(collection[i], i, collection));
    }
    return response;
  };
  ...
  _.zip = function() {
    ...
    var length = Math.max.apply(null, _.map(arguments, function (arr) {
      return arr.length;
    }));
    var zipped = [];
    var zip;
    for(var x = 0; x < length; x++) {
      ...
      for(var y = 0; y < arguments.length; y++) {
        zip.push(arguments[y][x] !== undefined ? arguments[y][x] : undefined);
      }
      zipped.push(zip);
    }
    return zipped;
